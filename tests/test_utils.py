...
from dpodl_core.utils import save_checkpoint, load_checkpoint, collate_batch, transfer_weights
...
def test_load_checkpoint_exists(mock_torch_load, mock_isfile, mock_model, mock_optimizer):
    ...
    # Call the function
    epoch, loss, loaded_dpodl_state = load_checkpoint(checkpoint_path, load_model, load_optimizer)
