...
from .utils import logger, setup_main_file_logging, restore_original_streams # Import logger if configured globally
...
def run_training(
    ...
    # This will capture all print statements and errors from this point onwards into trainer.log
    setup_main_file_logging(log_file_name="trainer.log", logs_dir="logs/trainer_runs")
    ...
    try:
        ...
        # Optionally, you can add a final log message before restoring streams if needed.
        # logger.info("Training script finished, about to restore console output.")
        ...
        # This is important if other processes/scripts expect normal console output after this script runs.
        restore_original_streams()
        logger.info("Restored original stdout/stderr streams. Trainer script finished.")
